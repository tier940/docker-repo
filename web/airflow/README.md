...
* Based on official Airflow 2 Image [apache/airflow:2.4.2-python3.10](https://hub.docker.com/r/apache/airflow) and uses the official [Postgres](https://hub.docker.com/_/postgres/) as backend and [Redis](https://hub.docker.com/_/redis/) as queue
